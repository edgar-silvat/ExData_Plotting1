plot2<-function(){
    ...
    png(filename = "plot2.png",width = 480,height=480,units="px") #Open png Device to ouput plot
    plot(energy$Time,energy$Global_active_power,type="l",xlab = "",ylab="Global Active Power (kilowatts)") #Make Plot
